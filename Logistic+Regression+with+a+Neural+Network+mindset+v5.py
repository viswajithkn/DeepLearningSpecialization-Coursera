...
train_set_x_flatten = np.reshape(train_set_x_orig,[m_train,num_px*num_px*3],order = 'C').T
test_set_x_flatten = np.reshape(test_set_x_orig,[m_test,num_px*num_px*3],order = 'C').T
### END CODE HERE ###
